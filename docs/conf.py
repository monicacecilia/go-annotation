...
issues_github_path = 'monicacecilia/go-ontology'
...
htmlhelp_basename = 'go-ontology-help'
...
latex_documents = [
    (master_doc, 'go-ontology.tex', 'go-ontology Documentation',
     'GOC Annotation Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'go-ontology', 'go-ontology Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'go-ontology', 'go-ontology Documentation',
     author, 'go-ontology', 'One line description of project.',
     'Miscellaneous'),
]
